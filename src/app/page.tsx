...
function Testimonials() {
  return (
    <section id="testimonials" className="py-24 bg-[var(--color-dark)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4">Trusted by Guests</h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Don&apos;t just take our word for it. See what our guests have to say on Turo.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
          ...
          <div className="bg-[var(--color-dark-light)] rounded-2xl p-8 border border-white/5 text-center">
            ...
            <div className="text-[var(--color-primary-light)] text-lg font-semibold mb-1">Five-Star</div>
            <div className="text-gray-400 text-sm">Guest Experiences</div>
          </div>

          <div className="bg-[var(--color-dark-light)] rounded-2xl p-8 border border-white/5 text-center">
            <div className="text-5xl font-bold text-white mb-2">10+</div>
            <div className="text-[var(--color-accent)] text-lg font-semibold mb-1">Verified</div>
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white px-8 py-4 rounded-full text-lg font-semibold transition-colors"
          >
            Read Reviews on Turo
